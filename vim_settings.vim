...
set shada='100,n/hhome/Documents/nvim/files/info/viminfo  "OBSOLETS: set viminfo='100,n$HOME/.config/nvim/files/info/viminfo
...
" Toggle zoom window
" nnoremap <leader>z <ESC><C-w>m
" nmap <leader>z <ESC><C-w>m
nmap <leader><leader> <ESC><C-w>m
nmap <C-m> <ESC><C-w>m
nmap <C-F11> <ESC><C-w>m
...
nnoremap <leader>b  :e /hhome/.bashrc<CR>
nnoremap <leader>a  :e /hhome/.bash_aliases<CR>
nnoremap <leader>cs :e $DOTFILES_HOME/rails_cheatsheet_cg_1.txt<CR>
" nnoremap <leader>v  :e $DOTFILES_HOME/init.vim<CR>
nnoremap <leader>v  :e $DOTFILES_HOME/vim_settings.vim<CR>
...
noremap  <leader>p  :e $DOTFILES_HOME/plugin.vim<CR>
" noremap  <leader>sv :source $DOTFILES_HOME/init.vim<CR>
noremap  <leader>sv :source $DOTFILES_HOME/vim_settings.vim<CR>
" noremap  <leader>sp :source $DOTFILES_HOME/vim_plugins.vim<CR>
noremap  <leader>sp :source $DOTFILES_HOME/plugin.vim<CR>
...
if filereadable(expand("/hhome/Documents/nvim/session/nvim__last_session.vim"))
" if filereadable(expand("~/workspace/nvim__last_session.vim"))
    ...
    " nnoremap <leader>ss :mksession! /hhome/Documents/nvim/session/nvim__last_session.vim
    nnoremap <leader>ss :SSave! nvim__last_session
else
    " nnoremap <leader>ss :mksession! $HOME/.config/nvim/last_session.vim
    " nnoremap <leader>ss :mksession! /hhome/Documents/nvim/session/last_session.vim
    nnoremap <leader>ss :SSave! LAST_SESSION
endif
...
" if filereadable(expand("$VIM_SCRIPTS_HOME/quickfix.vim"))
...
"                |___/                                      |___/
" if filereadable(expand("$VIM_PLUG_CFG_HOME/goyo.vim"))
